...
$redirectURL = "http://localhost:9095/lms/fbgraph/fb-callback.php";
$permissions = ['email'];
		...
		<div class="container">
			<div class="page-breadcrumb-content text-center">
				<div class="page-breadcrumb-title">
					<h2 class="breadcrumb-head black bold">Genius <span>Sign Up</span></h2>
				</div>
			...
			<div class="contact_third_form">
				...
				<div class="form">
					...
					<div class="container">
						...
						<li class="tab active"><a href="#signup">Sign Up as a Teacher</a></li>
						<li class="tab"><a href="#login">Sign Up as a Student</a></li>
					</ul>

					<div class="tab-content">
						<div id="signup">
							<h1>Sign Up for Free as a Teacher</h1>
						<form action="datatacle/addtutor.php" enctype="multipart/form-data" method="post" id="tutorvalidateForm">
								<center><img
...
<div class="top-row">
	<div class="field-wrap form-group">
						...
						<div id="login">
							<h1>Sign Up for Free as a Student</h1>

							<form action="datatacle/addstudent.php" method="post" id="studentvalidateForm">
								<input type="hidden" name="enroll" value="<?=strtoupper(substr(md5(rand(0, 10)), 0, 8))?>">
								<div class="top-row">


									<div class="field-wrap form-group">
										<label for="">Student Name<span class="req">*</span></label><br>
										<input type="text" pattern="[a-zA-Z][a-zA-Z\s]*" name="sname" required autocomplete="off"
											placeholder="Enter Your Name" class="form-control"/>
									</div>

									<div class="field-wrap form-group">
										<label for="">Phone Number<span class="req">*</span></label><br>
										<input type="number"  required autocomplete="off"
											placeholder="Enter Your Phone Number" name="sphone" class="form-control"/>
									</div>
								...
								<div class="top-row">
									<div class="field-wrap form-group">
										<label for="">Student Email<span class="req">*</span></label><br>
										<input type="email"
											placeholder="Enter your Email Address" name="semail" required autocomplete="off" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" class="form-control"/>
									</div>
										<div class="field-wrap form-group">
								<label for="">Password<span class="req">*</span></label><br>
								<input type="password"  required autocomplete="off"
									placeholder="Enter Your Password" name="spass" pattern=".{8,}" class="form-control" />
							</div>
							...
							<div class="field-wrap form-group">
										<label for="">Location<span class="req">*</span></label><br>
										<input type="text"  required autocomplete="off"
											placeholder="Enter Your Location" name="sloc" class="form-control"/>
									</div>


						</div><br>

								<button class="button button-block" type="submit" name="add_student">Student Register</button>
...
<script>
  ...
  window.onload=()=>{
	...
	<script>
		...
		$('#tutorvalidateForm').bootstrapValidator({
fields: {
	tutorname: {
		validators: {
			stringLength: {
...
<script>
$('#studentvalidateForm').bootstrapValidator({
	fields: {
	sname: {
		validators: {
			stringLength: {
